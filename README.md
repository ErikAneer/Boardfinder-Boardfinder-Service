# What is the Boardfinder-Boardfinder-Service?

The Boardfinder-Boardfinder-Service is the Spring Boot Boardfinder Service for the Boardfinder App that handels products and filter searches to show recommended products (snowboards).
